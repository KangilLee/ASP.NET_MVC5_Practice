...
namespace Assignment9.Controllers
{
    ...
    public class ArtistsController : Controller
    {
        ...
        {
            var o = m.ArtistGetByIdWithMediaItem(id.GetValueOrDefault());
        ...
        public ActionResult AddMediaItem(int? id)
        {
            ...
            MediaItemAddForm addForm = new MediaItemAddForm();
        ...
        public ActionResult AddMediaItem(MediaItemAdd newItem)
        {
            try
            {
                ...
                var addedNewItem = m.MediaItemAdd(newItem);
                ...
                {
                    return RedirectToAction("Details", "Artists", new { id = addedNewItem.Id });
                }
            }
            catch
            {
