                ...
                c => new
                    {
                        ...
                        Cooordinator = c.String(nullable: false, maxLength: 100),
                    })
                .PrimaryKey(t => t.Id);
                ...
                c => new
                    {
                        Id = c.Int(nullable: false, identity: true),
                        Name = c.String(nullable: false, maxLength: 100),
                        BirthName = c.String(nullable: false, maxLength: 100),
                        Executive = c.String(nullable: false, maxLength: 100),
                        Genre = c.String(nullable: false, maxLength: 100),
                ...
                c => new
                    {
                        Id = c.Int(nullable: false, identity: true),
                        Name = c.String(nullable: false, maxLength: 100),
                        Clerk = c.String(nullable: false, maxLength: 100),
                        Composers = c.String(nullable: false, maxLength: 100),
                        Genre = c.String(nullable: false, maxLength: 100),
                    })
                .PrimaryKey(t => t.Id);
